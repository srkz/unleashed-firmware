...
/** The name a manual format is listed under: the protocol's, or "HID H10304", "Continental
 * C10202", "Casi-Rusco C10106" and so on for the formats saved as another protocol. */
